...
public class AssetController {
    ...
    public void getToken(@PathVariable String projectId, String userSeq, @RequestBody MarketTokenDto marketTokenDto) {
        tokenService.getToken(projectId, userSeq, marketTokenDto);
    }
